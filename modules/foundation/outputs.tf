...
output "nlp_identity_client_id" { value = azurerm_user_assigned_identity.nlp.client_id }
...
output "worker_identity_client_id" { value = azurerm_user_assigned_identity.worker.client_id }
